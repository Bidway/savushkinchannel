  ...
  return (
    <form onSubmit={handleSubmit} className={"params"}>
      ...
      {nodeType.includes("sub") && (
        <SelectContextMenu parentKey={nodeType} setOptionParams={setOptionParams} name={"subtype_param"} title={"Общие параметры"} value={optionParams.filter(param => param.name === "Общие параметры")}/>
      )}
      {nodeType.includes("cha") && (
        <SelectContextMenu parentKey={nodeType} setOptionParams={setOptionParams} name={"channel_param"} title={"Общие параметры"} value={optionParams.filter(param => param.name === "Общие параметры")}/>
      )}
